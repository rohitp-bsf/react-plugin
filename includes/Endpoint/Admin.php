...
class Admin {
	...
	private function __construct() {
        $plugin = ReactPlugin\Plugin::get_instance();
    ...
    public function get_contact_email( $request ) {
        $example_option = get_option( 'react_plugin_contact_email' );
    ...
    public function update_contact_email( $request ) {
        $updated = update_option( 'react_plugin_contact_email', $request->get_param( 'email' ) );
    ...
    public function delete_contact_email( $request ) {
        $deleted = delete_option( 'react_plugin_contact_email' );
