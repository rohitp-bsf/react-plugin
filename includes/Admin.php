...
class Admin {
	...
	private function __construct() {
		...
		$this->plugin_basename = plugin_basename( plugin_dir_path( realpath( __DIR__ ) ) . $this->plugin_slug . '.php' );
	}
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_options_page(
			__( 'React Plugin Contact Form', $this->plugin_slug ),
			__( 'React Plugin Contact Form', $this->plugin_slug ),
			'manage_options',
			$this->plugin_slug,
