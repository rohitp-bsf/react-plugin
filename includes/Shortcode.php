...
class Shortcode {
	...
	private function __construct() {
		...
		add_shortcode( 'react-plugin-contact-form', array( $this, 'shortcode' ) );
	}
	...
	public function register_frontend_scripts() {
		...
		wp_register_script( $this->plugin_slug . '-shortcode-script',
            plugins_url( 'assets/js/shortcode.js', __DIR__ ),
            array( 'jquery' ),
            $this->version );

		wp_register_style( $this->plugin_slug . '-shortcode-style',
            plugins_url( 'assets/css/shortcode.css', __DIR__ ),
            $this->version );
	}
	...
	public function shortcode( $atts ) {
		...
		$object_name = 'react_plugin_object_' . uniqid();

		$object = shortcode_atts( array(
			'title'       => 'React Plugin Contact Form',
		...
		$shortcode = '<div class="react-plugin-shortcode" data-object-id="' . $object_name . '"></div>';
		return $shortcode;
	}
}
